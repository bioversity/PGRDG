                        ...
                        <div class="btn-group btn-group-justified" data-toggle="buttons">
                                <label class="btn btn-default">
                                        ...
                                        <ul class="header-dropdown-list hidden-xs">
                                                <li>
                                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <img src="<?php print $domain; ?>/common/media/img/admin/blank.gif" class="flag flag-us" alt="United States"> <span> US</span> <i class="fa fa-angle-down"></i> </a>
                                                        <ul class="dropdown-menu pull-right">
                                                                <li class="active">
                                                                        <a href="javascript:void(0);"><img src="<?php print $domain; ?>/common/media/img/admin/blank.gif" class="flag flag-us" alt="United States"> English (US)</a>
                                                                </li>
                                                                <li>
                                ...
                                <div class="login-info">
                                        <span> <!-- User image size is adjusted inside CSS, it should stay as is -->
                                                ...
                                                <a href="javascript:void(0);" id="show-shortcut" data-action="toggleShortcut">
                                                        <img src="<?php print $domain; ?>/common/media/img/admin/avatars/sunny.png" alt="me" class="online" />
                                                        <span>
                                                                john.doe
                                                        </span>
                        ...
                        <ul>
                                ...
                                <li>
                                        ...
                                        <li class="chat-users top-menu-invisible">
                                                ...
                                                <ul>
                                                        <li>
                                                                ...
                                                                <div class="display-users">
                                                                        ...
                                                                        data-content="
                                                                        <div class='usr-card'>
                                                                                <img src='<?php print $domain; ?>/common/media/img/admin/avatars/5.png' alt='Sadi Orlaf'>
                                                                ...
                                                                data-content="
                                                                <div class='usr-card'>
                                                                        <img src='<?php print $domain; ?>/common/media/img/admin/avatars/1.png' alt='Jessica Dolof'>
                                                                        <div class='usr-card-content'>
                                                                                <h3>Jessica Dolof</h3>
                                                        ...
                                                        data-content="
                                                        <div class='usr-card'>
                                                                <img src='<?php print $domain; ?>/common/media/img/admin/avatars/3.png' alt='Zekarburg Almandalie'>
                                                                <div class='usr-card-content'>
                                                ...
                                                data-content="
                                                <div class='usr-card'>
                                                        <img src='<?php print $domain; ?>/common/media/img/admin/avatars/4.png' alt='Barley Krazurkth'>
                                                        <div class='usr-card-content'>
                                        ...
                                        data-content="
                                        <div class='usr-card'>
                                                <img src='<?php print $domain; ?>/common/media/img/admin/avatars/female.png' alt='Farhana Amrin'>
                                                <div class='usr-card-content'>
                                                        <h3>Farhana Amrin</h3>
                                ...
                                data-content="
                                <div class='usr-card'>
                                        <img src='<?php print $domain; ?>/common/media/img/admin/avatars/male.png' alt='Lezley Jacob'>
                                        <div class='usr-card-content'>
                                                <h3>Lezley Jacob</h3>
                                                <p>Sales Director</p>
                                        </div>
