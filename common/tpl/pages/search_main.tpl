...
<div id="advanced_search_home" style="display: none;">
        ...
        <br />
        <p>This page can be used to select the metadata or 'fields' that can ve used to search data.<br />
...
<div class="row" id="big_buttons"></div>
