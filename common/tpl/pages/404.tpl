...
<div class="signature">
        <span class="fa fa-camera"></span> <?php print str_replace(array("{NAME}", "{URL}"), array("Timo Balk", "http://www.redbubble.com/people/timobalk"), $i18n[$lang]["messages"]["photo_author_caption"]); ?>
</div>
