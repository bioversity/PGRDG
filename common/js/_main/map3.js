 ...
 *======================================================================================*/
	...
	/**
	 * Check available layers on core and list on menu
	 */
 ...
 *======================================================================================*/
	...
	*/
		/**
		* Function called when user starts measurements
		* @param  {void} click_on_start Coordinates where user has clicked
		*/
		...
		/**
		* Keep measurements on pause status
		*/
		...
		*/
		...
		/**
		* Calculates distances depending the user preferences
		* @param  {string} type    The preferred measuration type (length, area or point)
		* @param  {object} options Measurations params (lon, lat, click_on_start, title, callback{function})
		* @return {Function} callback Called function
		*/
